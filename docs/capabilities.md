...
| Sparse-file peak RSS | Fixed-budget histogram and WAV consumers stayed below a 32 MiB ceiling as artifacts grew to 1 MiB and 64 MiB; both enforced non-negative growth metrics were zero | The measured read-side high-water mark depends on chunk plus state, not total file size, on the recorded platform. |
